...
type Props = { resultsCount: number } & ComponentPropsWithoutRef<'input'>

export const SearchInput = ({ className, resultsCount, ...props }: Props) => {
  return (
    <div className={s.root}>
      ...
      <div className={s.resultsCount}>
        {resultsCount} {resultsCount === 1 ? 'test' : 'tests'}
      </div>
    </div>
  )
}
